/**
 * Well-known constants for the product SDK.
 */
 ...
 *
 * Use these with `createPapiProvider()` to get a typed provider for
 * a specific chain without hard-coding hex strings in your app.
 */
